...
outputDirectoryBase = "/store/user/cmantill/analyzer/"+analysis+"/"+label+"/"
...
# datasetList['nano/v1/2017/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8.list'] = [0, 2, "2017", "TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8"]
